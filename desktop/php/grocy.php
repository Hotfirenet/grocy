...
<div class="row row-overflow">
   ...
   <div class="alert alert-info">
        <p>{{Exemple d’URL à appeler avec l'application scanner depuis l'exterieur}} : <?php echo network::getNetworkAccess('external')?>/plugins/grocy/core/api/grocy.php?apikey=<?php echo  jeedom::getApiKey('grocy');?></p>
        <p>{{Exemple d’URL à appeler avec l'application scanner depuis l'interieur}} : <?php echo network::getNetworkAccess('internal')?>/plugins/grocy/core/api/grocy.php?apikey=<?php echo  jeedom::getApiKey('grocy');?></p>
    </div>
...
<?php include_file('desktop', 'grocy', 'js', 'grocy');?>
